...
###initIP_EP200_FPGA(0, 1, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_1.hex")
initIP_EP200_FPGA(0, 1, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_2.hex")
...
initIP_EP201("SGIO_1",0,1,1000000,0x0000,0x800000,0x90,0x00,0x00)
# bits 33-48 are outputs
initIP_EP201("SGIO_2",0,1,1000000,0x0101,0x800010,0x91,0x00,0x00)
initIP_EP201("SGIO_3",0,1,1000000,0x0101,0x800020,0x92,0x00,0x00)
...
dbLoadRecords("$(SOFTGLUE)/db/softGlue_SignalShow.db","P=14LAB:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")

# Load a set of database fragments for each single-register component.
dbLoadRecords("$(SOFTGLUE)/db/softGlue_FPGAContent.db", "P=14LAB:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")
...
# circuit elements.
#dbLoadRecords("$(SOFTGLUE)/db/softGlue_FPGAContent_octupole.db", "P=14LAB:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")

# Interrupt support.
# doesn't fit in vxWorks command line space
putenv "SDB=$(SOFTGLUE)/db/softGlue_FPGAInt.db"
str=malloc(500)
strcpy(str,"P=14LAB:,H=softGlue:,PORT1=SGIO_1,ADDR1=0x800000,PORT2=SGIO_2,ADDR2=0x800010,PORT3=SGIO_3,ADDR3=0x800020")
dbLoadRecords("$(SDB)",str)
