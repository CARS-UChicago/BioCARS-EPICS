...
dbLoadDatabase("../../dbd/iocCARSCygwin.dbd")
iocCARSCygwin_registerRecordDeviceDriver(pdbbase)
...
# autoshutter test
dbLoadRecords("$(TOP)/CARSApp/Db/myBO.db", "P=CARS:")

# autoshutter test
dbLoadRecords("$(TOP)/CARSApp/Db/alarmClockTest.vdb", "P=CARS:,N=1")

#dbLoadRecords("$(TOP)/CARSApp/Db/IDBLTest.db", "real=CARS:m1,soft=CARS:softTest")
...
dbLoadRecords("$(SSCAN)/sscanApp/Db/standardScans.db","P=CARS:,MAXPTS1=2000,MAXPTS2=1000,MAXPTS3=10,MAXPTS4=10,MAXPTSH=2000")
...
# XIA shutter
#dbLoadRecords("$(OPTICS)/opticsApp/Db/XIA_shutter.db","P=CARS:,S=shutter1,PORT=serial2,ADDRESS=0123")
