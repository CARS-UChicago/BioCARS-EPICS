...
#set_savefile_path("/export/oxygen4/MOONEY/epics/synApps/support/CARS/iocBoot/iocvxWorks", "autosave")

# status PVs
#save_restoreSet_UseStatusPVs(1)
save_restoreSet_status_prefix("CARS:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=CARS:, DEAD_SECONDS=5")
...
set_requestfile_path(top, "CARSApp/Db")
