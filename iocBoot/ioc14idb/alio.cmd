...
#dbLoadRecords("$(CARS)/CARSApp/Db/exphi.db","P=14IDB:,E=Exphi,PORT=pmacAliog,TMOT=3.0,
#AV=P1,OPV=P2,CPV=P3,EPEV=P4,EPV=P5,MTV=P6,SV=P7,EV=P8,SP=8,OP=3,PP=3,DESC='14-ID-B'")
strcpy(str,"P=14IDB:,E=Exphi,PORT=pmacAliog,TMOT=3.0,AV=P1,OPV=P2,CPV=P3,EPEV=P4,")
strcat(str,"EPV=P5,MTV=P6,SV=P7,EV=P8,SP=8,OP=3,PP=3,DESC='14-ID-B'")
dbLoadRecords("$(CARS)/CARSApp/Db/exphi.db",str)

# ALIO Goniometer
dbLoadRecords("$(ALIOG)/db/aliog.db","P=14IDB:,D=alio1,DESC=14-ID-B")
dbLoadRecords("$(ALIOG)/db/aliog_trajectory.db","P=14IDB:,D=alio1,DESC=14-ID-B")
#dbLoadRecords("$(ALIOG)/aliogApp/Db/sim/imcais.db","P=14IDB:,D=alio1,I=Is")

dbLoadTemplate("14ALIO.motor.substitutions")
